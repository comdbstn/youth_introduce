...
export default function PortfolioSection() {
  ...
  const portfolioData = [
    ...
    },
    {
      id: "airbnb-osaka",
      title: "Airbnb大阪西成区",
      subtitle: "宿泊施設マーケティング",
      period: "",
      url: "",
      description: "日本大阪西成区のAirbnb物件「Ausforum」のマーケティング戦略立案及び実行。リスティング最適化、写真撮影、価格戦略、レビュー管理を通じて予約率及び収益向上を達成。",
      tech: ["リスティング最適化", "価格戦略", "レビュー管理"],
      features: [
        "リスティング最適化 - タイトル、説明文、写真",
        "価格戦略 - ダイナミックプライシング",
        "ゲスト対応 - 多言語対応、レビュー管理",
      ],
      category: "marketing",
